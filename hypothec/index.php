        ...
        <div class="form_wrapper__inner">
            <form action="" class="row">
                ...
                <div class="col-xs-12 col-lg-8 confirmation">
                    ...
                    <div class="checkbox_wrapper">
                        <input type="checkbox" value="value1"> <label for="styled-checkbox">Справка по форме
                            банка</label>
                    </div>
                </div>
...
?>
    ...
    <h5><?= $arUser['NAME']; ?></h5>
    Ваш ипотечный брокер <input type="hidden" name="email" value="<?= $arUser['EMAIL']; ?>"> <a
            href="tel:<?= $arUser['PHONE']; ?>"><?= $arUser['PHONE']; ?></a> <input type="text"
    ...
    <div class="we-offer">
        ...
        <div class="row" style="text-align: center;">
            <a href="<?= SITE_DIR; ?>personal/hypothec/"
               class="add-apartment__button"> <? $APPLICATION->IncludeFile(SITE_DIR . 'include/hypothec/consultation_button_text.php'); ?> </a>
        </div>
    </div>
    <div class="tree">
        <div class="container">
